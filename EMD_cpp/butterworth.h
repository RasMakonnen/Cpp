...
/*
Returns the transfer function coefficients of an nth-order  digital Butterworth filter with normalized cutoff frequency.
*/
...
vector <double> ComputeNumCoeffs(int FilterOrder,double Lcutoff, double Ucutoff, vector<double> DenC)
{
    double *TCoeffs;
    double *NumCoeffs;
    complex<double> *NormalizedKernel;
    double Numbers[7]={0,1,2,3,4,5,6};
    int i;
    vector <double> A;
